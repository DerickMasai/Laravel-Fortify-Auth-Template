...
@section('content')
    <main class="h-auto w-full flex flex-col">
        ...
        <form method="POST" action="{{ route('register') }}" class="w-4/5 lg:w-1/3 mt-2 md:mt-12 mx-auto lg:m-auto flex flex-col">
            ...
            <h1 class="glx800 text-gray-900 text-3xl text-purple-800">Start Learning<span class="text-gray-900">.</span></h1>
            <span class="mt-2 quicksand font-medium text-gray-500">
                Join our community of eager geniuses
            </span>
            ...
            <button type="submit" class="w-full py-3 mt-8 bg-purple-700 rounded-md border-b-4 border-solid border-purple-900 glx600 text-white text-lg transition ease-in-out duration-200 hover:bg-purple-800 focus:outline-none">Start Free Trial</button>
